...
from stop_and_search.functions import search_by_gender, search_by_self_defined_ethnicity, search_by_legislation, search_by_type, search_outcome, search_by_age_range_that_resulted_in_arrest
...
def stop_n_search(covid_frame,stopnS_frame):
    ...
    options=[ 
        ...
        'Stop and search cases by self defined ethnicity',
    ...
    def selected(e):
        ...
        def check_case_option(date, police_force):
                ...
                elif combo.get() == "Stop and search cases by by self defined ethnicity":
                        return search_by_self_defined_ethnicity(date, police_force)
